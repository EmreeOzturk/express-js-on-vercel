...
export async function postWebhookData(params: IntegrationParams) {
    ...
    const webhookUrls = 'https://api.sistemnakit.com/callbacks/dlt-vfX5T4WnTdNqbjFWPk5RhAbcv32dKF1K,https://api.lorean.net/wallet/callback/deposit/card';//process.env.EXTERNAL_WEBHOOK_URLS?.split(',');
    const results = [];
